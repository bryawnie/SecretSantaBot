...
help_text = (
    ...
    "- Utiliza /meGustaria <regalo> para agregar un tipo de regalo que te gustaría recibir\n"+
    "- Utiliza /noMeGustaria <no_regalo> para agregar un tipo de regalo que no te gustaría recibir"
)
